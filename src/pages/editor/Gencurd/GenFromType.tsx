...
const GenFromType: React.FC<{
  setSchemaHandle?: (schemaOutput: any) => void;
}> = _props => {
  ...
  //@ts-ignore
  scemaJsonData.body[0].body[0].onEvent.change.actions[0].script = (
    a,
    b,
    c
  ) => {
  ...
  //@ts-ignore
  scemaJsonData.body[0].actions[0].onEvent.click.actions[0].script = (
    a: any,
    b: any,
    c: any
  ) => {
